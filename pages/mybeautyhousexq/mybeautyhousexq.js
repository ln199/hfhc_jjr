...
Page({
  ...
  edithouse() {
    wx.navigateTo({
      url: '../edithousecheckin_mzf/edithousecheckin_mzf?id=' + this.data.id
    })    
  },
  // 添加到收藏
  loveHouse() {
  ...
  onShareAppMessage: function () {
    ...
    return {
      title: title,
      imageUrl: imgUrl,
      path: '/pages/mybeautyhousexq/mybeautyhousexq?id='+this.data.id + '&sharename=' + sharename + '&sharephone=' + sharephone
    }    
  }
})