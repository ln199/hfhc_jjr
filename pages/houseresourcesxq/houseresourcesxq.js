// pages/houseresourcesxq/houseresourcesxq.js
...
Page({
  ...
  getDetail() {
    ...
    wx.request({
      url: _this.data.basicAppURL + 'ershoufang/content',
      method: "GET",
      data: data,
      header: {
      ...
      success(res) {
        if (res.data.code == 0) {
          ...
          _this.setData({
            ...
            waiwangtb: res.data.data.xiangqing.waiwangtb,
            lianmenggx: res.data.data.xiangqing.lianmenggx,
  ...
  delHouse() {
    ...
    wx.request({
      url: _this.data.basicURL + 'ershoufang/delete',
      method: "GET",
      data: data,
      header: {
        "XX-TOKEN": wx.getStorageSync('token'),
      ...
      success(res) {
        ...
        if (res.data.code == 0) {
          ...
          setTimeout(() => {
            wx.navigateTo({
              url: '../mysecondhouse/mysecondhouse',
            })
          }, 1500)
        } else {
          wx.showToast({
  ...
  editHouse() {
    wx.navigateTo({
      url: '../edithousecheckin/edithousecheckin?id=' + this.data.id,
    })
  },
  // 下载APP
  launchAppError(e) { },
  ...
  onShareAppMessage: function () {
    ...
    return {
      title: title,
      imageUrl: imgUrl,
      path: '/pages/houseresourcesxq/houseresourcesxq?id='+this.data.id + '&sharename=' + sharename + '&sharephone=' + sharephone
    }  
  }
})