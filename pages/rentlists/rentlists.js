...
Page({
  ...
  getHouseList() {
    ...
    this.data.reqTask = wx.request({
      url: _this.data.basicURL + 'chuzufang/search',
      method: "POST",
      data: data,
      header: {
  ...
  search(e) {
    wx.navigateTo({
      url: '../housesearch/housesearch?path=rentlists'
    })
  ...
  selectpr: function (e) {
    this.setData({
      ...
      price_id: e.currentTarget.dataset.price + 1
    });
  },
